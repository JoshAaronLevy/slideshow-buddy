...
function setupContentSecurityPolicy(customScheme) {
    electron_2.session.defaultSession.webRequest.onHeadersReceived((details, callback) => {
        ...
        const scriptSrc = electron_is_dev_1.default
        ...
        const defaultSrc = electron_is_dev_1.default
        ...
        callback({
            responseHeaders: Object.assign(Object.assign({}, details.responseHeaders), { 'Content-Security-Policy': [cspValue] }),
        });
    });
}
