        ...
        // Help menu
        {
            ...
            submenu: [
                ...
                { type: 'separator' },
                {
                    ...
                    click: async () => {
                        await electron_1.shell.openExternal('https://github.com/yourusername/slideshow-buddy/issues');
                    }
                },
                {
                    label: 'Learn More',
                    click: async () => {
                        await electron_1.shell.openExternal('https://github.com/yourusername/slideshow-buddy');
                    }
                }
            ]
        }
...
function showAboutDialog(parentWindow) {
    const appName = electron_1.app.name || 'Slideshow Buddy';
    const appVersion = electron_1.app.getVersion() || '1.0.0';
    electron_1.dialog.showMessageBox(parentWindow, {
        type: 'info',
        title: `About ${appName}`,
        message: appName,
        detail: [
        ...
        buttons: ['OK'],
        defaultId: 0,
        icon: path_1.default.join(__dirname, '../assets/appIcon.png') // You can add an app icon path here if available
    });
}
/**
...
function updateMenuState(state) {
    ...
    const findMenuItem = (menu, labels) => {
